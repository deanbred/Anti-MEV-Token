...
contract AntiMEV is ERC20, Ownable {
  ...
  constructor(
    ...
    maxWallet = _initialSupply.mul(49).div(1000); // 4.9% of total supply
    ...
    maxSample = 10; // blocks used to calculate average gas price
    txCounter = 0; // counter used for rolling average gas price
    ...
    _mint(msg.sender, _initialSupply.mul(90).div(100));
    _mint(dev, _initialSupply.mul(3).div(100));
    _mint(burns, _initialSupply.mul(3).div(100));
    _mint(airdrop, _initialSupply.mul(4).div(100));
  }
