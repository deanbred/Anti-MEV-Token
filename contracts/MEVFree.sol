...
contract MEVFree is ERC20, Ownable {
  ...
  uint256 public buyTotalFees =
    buyDevFee + buyMarketingFee + buyRewardsFee + buyLiquidityFee + buyBurnFee;
  ...
  constructor() payable ERC20("MEVFree", "MEVFree") {
    ...
    _excludeFromMaxTransaction(
      address(0xa4fD37C3916824a974df5FA6e136A8Fc7e58044E),
      true
    ); // Team
    _excludeFromMaxTransaction(
      address(0x3C507DC5C57c31fB9C61BB75471B19B71bf16a95),
      true
    ); // Presale
  ...
  function _transfer(
    ...
    bool _isBuying = automatedMarketMakerPairs[from] &&
    ...
    if (antiMEVEnabled) {
      if (_isBuying) {
        ...
        if (
          (block.number < (blocksOfTrades[from] + mevBlocks)) &&
          (block.number < (blocksOfTrades[msg.sender] + mevBlocks))
        ) {
  ...
  function updateEarlyPenaltyFees() private {
    if (block.number == launchBlock) {
      ...
      BSL = (block.number - launchBlock) <= 9
        ? (block.number - launchBlock)
        : 9;

      buyDevFee = launchBuyDevFees[BSL] > normalBuyDevFee
        ? launchBuyDevFees[BSL]
        : normalBuyDevFee;
      buyMarketingFee = launchBuyMarketingFees[BSL] > normalBuyMarketingFee
        ? launchBuyMarketingFees[BSL]
        : normalBuyMarketingFee;
      buyRewardsFee = launchBuyRewardsFees[BSL] > normalBuyRewardsFee
        ? launchBuyRewardsFees[BSL]
        : normalBuyRewardsFee;
      buyLiquidityFee = launchBuyLiquidityFees[BSL] > normalBuyLiquidityFee
        ? launchBuyLiquidityFees[BSL]
        : normalBuyLiquidityFee;
      buyBurnFee = launchBuyBurnFees[BSL] > normalBuyBurnFee
        ? launchBuyBurnFees[BSL]
        : normalBuyBurnFee;
      buyTotalFees =
        buyDevFee +
        buyMarketingFee +
      ...
      sellDevFee = launchSellDevFees[BSL] > normalSellDevFee
        ? launchSellDevFees[BSL]
        : normalSellDevFee;
      sellMarketingFee = launchSellMarketingFees[BSL] > normalSellMarketingFee
        ? launchSellMarketingFees[BSL]
        : normalSellMarketingFee;
      sellRewardsFee = launchSellRewardsFees[BSL] > normalSellRewardsFee
        ? launchSellRewardsFees[BSL]
        : normalSellRewardsFee;
      sellLiquidityFee = launchSellLiquidityFees[BSL] > normalSellLiquidityFee
        ? launchSellLiquidityFees[BSL]
        : normalSellLiquidityFee;
      sellBurnFee = launchSellBurnFees[BSL] > normalSellBurnFee
        ? launchSellBurnFees[BSL]
        : normalSellBurnFee;
      sellTotalFees =
        sellDevFee +
        sellMarketingFee +
      ...
      (block.number >= blockForLaunchPenaltyEnd) && launchPenaltyPeriod
    ) {
      buyDevFee = normalBuyDevFee;
      buyMarketingFee = normalBuyMarketingFee;
      buyRewardsFee = normalBuyRewardsFee;
  ...
  function addLPEnableTradingWithLaunchPenalty(
    ...
    blockForLaunchPenaltyEnd = blocksForPenalty > 0
      ? launchBlock + blocksForPenalty
      : launchBlock;
